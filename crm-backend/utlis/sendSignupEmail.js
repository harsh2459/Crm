...
module.exports = async function sendSignupEmail(to, employeeCode, name) {
    const message = {
            ...
            <html>
                <body style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
                    <div style="background-color: #f7f7f7; padding: 20px; border-radius: 10px; max-width: 600px; margin: auto;">
                        <h2 style="color: #4CAF50;">Welcome to BookMyAssignment, ${!name ? to.split('@')[0] : name}</h2>
                        ...
                        <p>If you have any questions or need assistance, feel free to reach out to our support team at <a href="mailto:support@yourapp.com" style="color: #4CAF50;">contact@bookmyassignments.com</a>.</p>
                        <p style="font-size: 12px; color: #999;">This email was sent from BookMyAssignment. If you didn't sign up, please ignore this email.</p>
             </div>
         </body>
      </html>
        `,
